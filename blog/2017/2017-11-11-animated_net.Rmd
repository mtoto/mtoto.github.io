...
```{r fig2, fig.height = 5.5, fig.width = 9, fig.align = "center", echo = F, message = F, eval = F}
require(gridExtra)
library(grid)
...
grid.arrange(p1, p2, ncol=2, top=textGrob("Network architecture and the problem",gp=gpar(fontsize=23,font=8),
                                          hjust = 0.75))
```
![](https://raw.githubusercontent.com/mtoto/mtoto.github.io/master/blog/2017/2017-11-11-animated_net_files/figure-html/fig2-1.png)
...
```
![](https://raw.githubusercontent.com/mtoto/mtoto.github.io/master/blog/2017/2017-11-11-animated_net_files/figure-html/unnamed-chunk-2-1.png)
...
```
![](https://raw.githubusercontent.com/mtoto/mtoto.github.io/master/blog/2017/2017-11-11-animated_net_files/figure-html/unnamed-chunk-4-1.png)
