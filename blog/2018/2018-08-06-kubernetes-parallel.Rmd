...
Plotting the results, the probability that 2 or more people will have the same birthday is 99% after 60 people in the room.
...
To illustrate the last approach, we will parallelize different regression models for the Boston housing dataset, a pretty common use case for parallelization in `R`.
