...
[After all the scraping, cleaning and parsing](add github link), I ended up with a final dataset containing 1196 policies and an indicator whether it mentions "*GDPR*" or not. I took the conservative approach of classifying the scraped policies as GDPR compliant only if the document contains the term, giving me 188 policies. It's not a whole lot - because most url's were either invalid or guarded against scraping; but hopefully just enough to get us going.
...
```
![](~/Documents/my_site/public/data/2018-06-19-gdpr/confs2.png)
